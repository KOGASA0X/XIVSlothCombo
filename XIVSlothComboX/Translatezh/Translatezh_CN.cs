...
public class Translatezh_CN
{
    ...
    { 
        ...
        {"Adds Lightspeed" , "添加光速。"  },
        {"Lucid Dreaming Weave Option" , "清醒梦编织选项"  },
        {"Adds Lucid Dreaming when MP drops below slider value" , "当MP下降到滑块值以下时添加清醒梦。"  },
        {"Divination Weave Option" , "占卜编织选项"  },
        {"Adds Divination" , "添加占卜。"  },
        {"Card Draw Weave Option" , "抽卡编织选项"  },
        {"Draws your cards" , "抽取你的卡牌。"  },
        {"Card Play Weave Option" , "打牌编织选项"  },
        {"Weaves your Balance or Spear card (best used with Quick Target Cards)" , "编织你的平衡或长矛卡（最好与快速目标卡一起使用）。"  },
        {"Lord of Crowns Weave Option" , "皇冠之主编织选项"  },
        {"Adds Lord Of Crowns" , "添加皇冠之主。"  },
        {"Earthly Star Option" , "地星选项"  },
        {"Adds Earthly Star.\nTo be used in conjunction with Redirect/Reaction/etc" , "添加地星和下面的插件一起用\n Redirect/Reaction/etc"  },
        #endregion
        #region Healing
        ...
        {"Aspected Helios Option" , "星象日珥选项"  },
        {"In Helios mode: Will Cast Aspected Helios when the HoT is missing on yourself.\nIn Aspected Helios mode: Is considered enabled regardless." , "在日珥模式下：当你自己缺少持续治疗效果时，将施放星象日珥。\n在星象日珥模式下：无论如何都被视为启用。"  },
        {"The Spire Option" , "尖塔选项"  },
        {"Adds The Spire when the card has been drawn" , "抽到卡牌时添加尖塔。"  },
        {"The Ewer Option" , "水瓶选项"  },
        {"Adds The Ewer when the card has been drawn" , "抽到卡牌时添加水瓶。"  },
        {"The Arrow Option" , "箭矢选项"  },
        {"Adds The Arrow (increased healing)  when the card has been drawn" , "等待翻译"  },
        {"The Bole Option" , "树干选项"  },
        {"Adds The Bole (Reduced Damage) when the card has been drawn" , "抽到卡牌时添加树干（减少伤害）。"  },
        #endregion
        #region Utility
        #endregion
        #region Cards
        ...
        {"Weaves oGCDs onto Quick Nock/Ladonsbite." , "将非GCD技能编织到快速射击/龙咬中。"  },
        ...
        {"Apex Arrow Option" , "顶点箭选项"  },
        {"Replaces Burst Shot with Apex Arrow when gauge is full and Blast Arrow when you are Blast Arrow ready." , "当能量槽满时，用顶点箭替换爆裂射击，当你准备好爆裂箭时，用爆裂箭替换。"  },
        {"oGcd Option" , "非GCD选项"  },
        {"Weave Sidewinder, Empyreal arrow, Rain of death, and Pitch perfect when available." , "在可用时编织侧风者、帝国箭、死亡之雨和完美音调。"  },
        {"Buffs Option" , "增益选项"  },
        {"Adds buffs onto the Advanced Bard feature." , "将增益效果添加到高级吟游诗人功能中。"  },
        {"Resonant Option" , "共鸣选项"  },
        {"Adds Resonant Arrow to the Rotation after Barrage." , "在弹幕之后将共鸣箭添加到循环中。"  },
        {"Buffs - Radiant Option" , "增益 - 辉煌选项"  },
        {"Adds Radiant Finale to theBuffs feature." , "等待翻译"  },
        {"Encore Option" , "安可选项"  },
        {"Adds Radiant Encore to the Rotation after Finale." , "在终曲之后将辉煌安可添加到循环中。"  },
        ...
        {"Adds Apex Arrow and Blast shot" , "添加顶点箭和爆裂射击。"  },
        {"Pooling Option" , "积累选项"  },
        {"84+ Pools Rain of death charges to allow for optimum burst phases." , "积累84+死亡之雨充能以允许最佳爆发阶段。"  },
        ...
        {"Dragonfire Dive movement option" , "龙炎冲移动选项"  },
        {"Adds Dragonfire Dive to the rotation when not moving." , "在不移动时将龙炎冲添加到循环中。"  },
        {"Rise of the Dragon Option" , "龙之觉醒选项"  },
        {"Adds Rise of the Dragon to the rotation." , "将龙之觉醒添加到循环中。"  },
        {"Stardiver Option" , "坠星冲选项"  },
        {"Adds Stardiver to the rotation." , "将坠星冲添加到循环中。"  },
        {"Stardiver movement option" , "坠星冲移动选项"  },
        {"Adds Stardiver to the rotation when not moving." , "在不移动时将坠星冲添加到循环中。"  },
        {"Starcross Option" , "星光穿越选项"  },
        {"Adds Starcross to the rotation." , "将星光穿越添加到循环中。"  },
        {"High Jump Option" , "高跳选项"  },
        {"Adds (High) Jump to the rotation." , "将（高）跳添加到循环中。"  },
        {"(High) Jump movement option" , "（高）跳移动选项"  },
        {"Adds (High) Jump to the rotation when not moving." , "在不移动时将（高）跳添加到循环中。"  },
        {"Mirage Dive Option" , "幻象冲选项"  },
        {"Adds Mirage Dive to the rotation." , "将幻象冲添加到循环中。"  },
        {"Geirskogul Option" , "盖尔斯科古尔选项"  },
        {"Adds Geirskogul to the rotation." , "将盖尔斯科古尔添加到循环中。"  },
        {"Nastrond Option" , "纳斯龙德选项"  },
        {"Adds Nastrond to the rotation." , "将纳斯龙德添加到循环中。"  },
        ...
        {"Adds True North before Chaos Thrust/Chaotic Spring, Fang And Claw and Wheeling Thrust when you are not in the correct position for the enhanced potency bonus." , "当你没有处于获得强化伤害加成的正确位置时，在混沌刺/混沌泉、龙牙龙爪和轮回刺之前使用真北。"  },
        #endregion
        {"Replaces Doom Spike with a full one-button AoE rotation.\nThis is the ideal option for newcomers to the job." , "将毁灭之刺替换为一键AoE技能循环。\n这是新手最理想的选项。"  },
        ...
        {"Adds Gauss Round and Ricochet or Double Check and Checkmate to the rotation. Will prevent overcapping." , "等待翻译"  },
        ...
        {"Gauss Round / Ricochet \nDouble Check / Checkmate Feature" , "等待翻译"  },
        {"Replace Gauss Round and Ricochet or Double Check and Checkmate with one or the other depending on which has more charges." , "等待翻译"  },
        ...
        {"Switches between Heat Blast and either Gauss Round and Ricochet or Double Check and Checkmate, depending on cooldown timers." , "等待翻译"  },
        ...
        {"Adds Perfect Balance and Masterful Blitz to the rotation" , "将无我和斗魂旋风脚添加到技能循环中"  },
        ...
        {"Replaces Arm of the Destroyer with a one-button full single target rotation.\nThese features are ideal if you want to customize the rotation." , "将灭绝替换为一键式全单体循环。\n这些功能适合你自定义技能循环。"  },
        ...
        {"Adds the Level 100 Opener to the rotation." , "将100级开场技能添加到技能循环中。"  },
        ...
        #region Cooldowns ST
        {"Arcane Circle Option" , "秘法环选项"  },
        {"Adds Arcane Circle to the rotation." , "将秘法环添加到技能循环中。"  },
        {"Plentiful Harvest Option" , "丰收选项"  },
        {"Adds Plentiful Harvest to the rotation." , "将丰收添加到技能循环中。"  },
        {"Bloodstalk Option" , "血追击选项"  },
        {"Adds Bloodstalk to the rotation." , "将血追击添加到技能循环中。"  },
        {"Gluttony Option" , "贪婪选项"  },
        {"Adds Gluttony to the rotation." , "将贪婪添加到技能循环中。"  },
        {"Enshroud Option" , "魂衣选项"  },
        {"Adds Enshroud to the rotation." , "将魂衣添加到技能循环中。"  },
        {"Double Enshroud Harvest moon" , "双重魂衣月收割"  },
        {"Uses Harvest Moon in 2 minute burst." , "在2分钟爆发中使用月收割。"  },
        ...
        {"Sacrificium Option" , "献祭选项"  },
        {"Adds Sacrificium to the rotation." , "将献祭添加到技能循环中。"  },
        {"Communio Finisher Option" , "团契终结技选项"  },
        {"Adds Communio to the rotation." , "将团契添加到技能循环中。"  },
        {"Perfectio Option" , "完美终章选项"  },
        {"Adds Perfectio to the rotation." , "将完美终章添加到技能循环中。"  },
        #endregion
        {"Gibbet and Gallows Option" , "绞刑/绞索选项"  },
        {"Adds Gibbet and Gallows to the rotation." , "将绞刑和绞索添加到技能循环中。"  },
        {"Ranged Filler Option" , "远程填充选项"  },
        {"Replaces the combo chain with Harpe when outside of melee range. Will not override Communio." , "当不在近战范围内时，用割喉替换连击链条。不会覆盖团契。"  },
        {"Add Harvest Moon" , "添加月收割"  },
        {"Adds Harvest Moon if available, when outside of melee range. Will not override Communio." , "当月收割可用时，在不处于近战范围时使用。不会覆盖团契。"  },
        ...
        {"Adds True North before Gibbet/Gallows when you are not in the correct position." , "当你没有处于正确位置时，在绞刑/绞索之前添加真北。"  },
        {"Hold True North for Gluttony Option" , "为贪婪保留真北选项"  },
        {"Will hold the last charge of True North for use with Gluttony, even when out of position for Gibbet/Gallows." , "即使在绞刑/绞索未处于正确位置时，也会为贪婪保留真北的最后一层。"  },
        #endregion
        #region Simple AoE
        {"Replaces Spinning Scythe with a one-button full single target rotation.\nThis is ideal for newcomers to the job." , "将回旋镰替换为一键式全单体循环。\n这是新手最理想的选项。"  },
        #endregion
        #region Advanced AoE
        {"Replaces Spinning Scythe with a full one-button AoE rotation.\nThese features are ideal if you want to customize the rotation." , "将回旋镰替换为一键式AoE循环。\n这些功能适合你自定义技能循环。"  },
        {"Whorl Of Death Option" , "死亡漩涡选项"  },
        {"Adds Whorl of Death to the rotation." , "将死亡漩涡添加到技能循环中。"  },
        {"Soul Scythe Option" , "灵魂镰选项"  },
        {"Adds Soul Scythe to the rotation." , "将灵魂镰添加到技能循环中。"  },
        #region Cooldowns
        {"Grim Swathe Option" , "阴森挥割选项"  },
        {"Adds Grim Swathe to the rotation." , "将阴森挥割添加到技能循环中。"  },
        {"Grim Reaping Option" , "阴森收割选项"  },
        {"Adds Grim Reaping to the rotation.\n(Disabling this may stop the one-button combo working during enshroud)" , "将阴森收割添加到技能循环中。\n（禁用此功能可能会导致魂衣期间一键连击无法生效）"  },
        {"Lemure's Scythe Option" , "夜游魂镰选项"  },
        {"Adds Lemure's Scythe to the rotation." , "将夜游魂镰添加到技能循环中。"  },
        #endregion
        {"Guillotine Option" , "断头台选项"  },
        {"Adds Guillotine to the rotation." , "将断头台添加到技能循环中。"  },
        #endregion
        #region Blood Stalk/Grim Swathe Combo Section
        {"Gluttony on Blood Stalk/Grim Swathe Feature" , "血追击/阴森挥割上的贪婪功能"  },
        {"Blood Stalk and Grim Swathe will turn into Gluttony when it is available." , "当贪婪可用时，血追击和阴森挥割将变为贪婪。"  },
        {"Gibbet and Gallows/Guillotine on Blood Stalk/Grim Swathe Feature" , "血追击/阴森挥割上的绞刑/绞索和断头台功能"  },
        {"Adds Gibbet and Gallows on Blood Stalk.\nAdds Guillotine on Grim Swathe." , "在血追击上添加绞刑和绞索。\n在阴森挥割上添加断头台。"  },
        {"Enshroud Combo Option" , "魂衣连击选项"  },
        {"Adds Enshroud combo (Void/Cross Reaping, Communio, and Lemure's Slice) on Blood Stalk and Grim Swathe." , "将魂衣连击（虚无/交错收割，团契，夜游魂切割）替换至血追击和阴森挥割上。"  },
        {"Sacrificium only Option" , "仅献祭选项"  },
        {"Adds only Sacrificium on Blood Stalk and Grim Swathe while enshrouded." , "在魂衣状态下，仅在血追击和阴森挥割上添加献祭。"  },
        #endregion
        #region Miscellaneous
        {"Arcane Circle Harvest Feature" , "秘法环收获功能"  },
        {"Replaces Arcane Circle with Plentiful Harvest when you have stacks of Immortal Sacrifice." , "当你拥有不灭献祭层数时，将秘法环替换为丰收。"  },
        {"Regress Feature" , "退却功能"  },
        {"Changes both Hell's Ingress and Hell's Egress turn into Regress when Threshold is active." , "当门槛激活时，将地狱出入口技能变为退却。"  },
        {"Soulsow Reminder Feature" , "灵魂播种提醒功能"  },
        {"Adds Soulsow to the skills selected below when out of combat. \nWill also add Soulsow to Harpe when in combat and no target is selected." , "在非战斗状态下，将灵魂之锄添加到以下选择的技能中。\n在战斗中且未选择目标时，也会将灵魂之锄添加到哈普技能中。"  },
        {"Harpe Harvest Moon Feature" , "哈普收获月功能"  },
        {"Replaces Harpe with Harvest Moon when you are in combat with Soulsow active." , "当灵魂之锄激活时，在战斗中将哈普替换为收获月。"  },
        {"Enshroud Protection Feature" , "笼罩保护功能"  },
        {"Turns Enshroud into Gibbet/Gallows to protect Soul Reaver waste." , "将笼罩变为绞刑架/绞刑台以保护灵魂收割者的浪费。"  },
        {"Communio on Gibbet/Gallows and Guillotine Feature" , "绞刑架/绞刑台和断头台的共鸣功能"  },
        {"Adds Communio to Gibbet/Gallows and Guillotine." , "将共鸣添加到绞刑架/绞刑台和断头台。"  },
        {"Lemure's Slice/Scythe Option" , "幽灵的切割/镰刀选项"  },
        {"Adds Lemure's Slice to Gibbet/Gallows and Lemure's Scythe to Guillotine." , "将幽灵的切割添加到绞刑架/绞刑台，将幽灵的镰刀添加到断头台。"  },
        {"Enshroud to Communio Feature" , "笼罩到共鸣功能"  },
        {"Turns Enshroud to Communio when available to use." , "在可用时将笼罩变为共鸣。"  },
        {"True North Feature" , "真北功能"  },
        {"Adds True North when under Gluttony and if Gibbet/Gallows options are selected to replace those skills." , "在贪食状态下，如果选择了绞刑架/绞刑台选项以替换这些技能，则添加真北。"  },
        {"Soulsow Reminder during Combat" , "战斗中的灵魂之锄提醒"  },
        {"Adds Soulsow to Harpe during combat when no target is selected." , "在战斗中未选择目标时，将灵魂之锄添加到哈普技能中。"  },
        #endregion
        #endregion
        #region RED MAGE
        ...
        {"Magick Barrier Overlap Protection" , "等待翻译"  },
        {"Disables Magick Barrier when buffed by another Red Mage's Magick Barrier." , "等待翻译"  },
        #endregion
        #endregion
        #region SAGE
        ...
        {"Philosophia Option" , "等待翻译"  },
        {"Adds Philosophia." , "等待翻译"  },
        {"Warning, will force the use of Eukrasia Prognosis, and normal Prognosis will be unavailable." , "等待翻译"  },
        #endregion
        #region Misc Healing
        {"Taurochole to Druochole Feature" , "等待翻译"  },
        {"Turns Taurochole to Druochole when Taurochole is on cooldown." , "等待翻译"  },
        #endregion
        #region Utility
        {"Spell Overlap Protection" , "等待翻译"  },
        {"Prevents you from wasting actions if under the effect of someone else's actions" , "等待翻译"  },
        {"Under Kerachole" , "等待翻译"  },
        {"Don't use Kerachole when under the effect of someone's Kerachole" , "等待翻译"  },
        {"Under Sacred Soil" , "等待翻译"  },
        {"Don't use Kerachole when under the effect of someone's Sacred Soil" , "等待翻译"  },
        {"Under Panhaima" , "等待翻译"  },
        {"Don't use Panhaima when under the effect of someone's Panhaima" , "等待翻译"  },
        {"Under Philosophia" , "等待翻译"  },
        ...
        #endregion
        #region VIPER
        {"Replaces Steel Fangs with a full one-button single target rotation.\nThis is the ideal option for newcomers to the job." , "将钢牙替换为一个完整的单键单体循环。\n这是新手的理想选择。"  },
        #region Advanced ST Viper
        {"Replaces Steel Fangs with a full one-button single target rotation.\nThese features are ideal if you want to customize the rotation." , "将钢牙替换为一个完整的单键单体循环。\n这些功能非常适合自定义循环。"  },
        {"Adds the Balance opener to the rotation.\n Does not check positional choice.\n Always does Hunter's Coil first ( FLANK )" , "将平衡起手添加到循环中。\n不检查位置选择。\n始终优先使用猎人的缠绕（侧面攻击）。"  },
        #region Cooldowns ST
        {"Serpents Ire" , "蛇之怒"  },
        {"Adds Serpents Ire to the rotation." , "将蛇之怒添加到循环中。"  },
        {"Vicewinder" , "反曲之蛇"  },
        {"Adds Vicewinder to the rotation." , "将反曲之蛇添加到循环中。"  },
        {"Vicewinder Combo" , "反曲之蛇连击"  },
        {"Adds Swiftskin's Coil and Hunter's Coil to the rotation.\nWill automatically swap depending on your position." , "将迅皮缠绕和猎人缠绕添加到循环中。\n根据你的站位自动切换。"  },
        #endregion
        {"Serpents Tail" , "蛇尾"  },
        {"Adds Serpents Tail to the rotation." , "将蛇尾添加到循环中。"  },
        {"Uncoiled Fury" , "解缠之怒"  },
        {"Adds Uncoiled Fury to the rotation." , "将解缠之怒添加到循环中。"  },
        {"Uncoiled Fury Combo" , "解缠之怒连击"  },
        {"Adds Uncoiled Twinfang and Uncoiled Twinblood to the rotation." , "将解缠的双牙和解缠的双血添加到循环中。"  },
        {"Reawaken" , "复苏"  },
        {"Adds Reawaken to the rotation." , "将复苏添加到循环中。"  },
        {"Reawaken Combo" , "复苏连击"  },
        {"Adds Generation and Legacy to the rotation." , "将生代和遗产添加到循环中。"  },
        {"Adds Writhing Snap to the rotation when you are out of melee range." , "当你处于近战范围之外时，将扭曲之击添加到循环中。"  },
        {"Add Uncoiled Fury" , "添加解缠之怒"  },
        {"Adds Uncoiled Fury to the rotation when you are out of melee range and have Rattling Coil charges." , "当你处于近战范围之外并且拥有蛇缠之怒充能时，将解缠之怒添加到循环中。"  },
        {"Adds True North when you are not in the correct position for the enhanced potency bonus." , "当你不在正确的位置以获得增强效果时，添加真北技能。"  },
        #endregion
        {"Replaces Steel Maw with a full one-button AoE rotation.\nThis is the ideal option for newcomers to the job." , "将钢颚替换为一个完整的单键范围循环。\n这是新手的理想选择。"  },
        #region Advanced AoE Viper
        {"Replaces Steel Maw with a full one-button AoE rotation.\nThese features are ideal if you want to customize the rotation." , "将钢颚替换为一个完整的单键范围循环。\n这些功能非常适合自定义循环。"  },
        #region Cooldowns AoE
        {"Vicepit" , "反曲陷阱"  },
        {"Adds Vicepit to the rotation." , "将反曲陷阱添加到循环中。"  },
        {"Disable Range Check" , "禁用距离检查"  },
        {"Disables the range check for Vicepit, so it will be used even without a target selected." , "禁用反曲陷阱的距离检查，即使没有选定目标也会使用它。"  },
        {"Vicepit Combo" , "反曲陷阱连击"  },
        {"Adds Swiftskin's Den and Hunter's Den to the rotation." , "将迅皮洞穴和猎人洞穴添加到循环中。"  },
        {"Disables the range check for Swiftskin's Den and Hunter's Den, so they will be used even without a target selected." , "禁用迅皮洞穴和猎人洞穴的距离检查，即使没有选定目标也会使用它们。"  },
        #endregion
        {"Disables the range check for Reawaken, so it will be used even without a target selected." , "禁用复苏的距离检查，即使没有选定目标也会使用它。"  },
        #endregion
        {"Vicewinder - Coils" , "反曲之蛇 - 缠绕"  },
        {"Replaces Vicewinder with Hunter's/Swiftskin's Coils.\nWill automatically swap depending on your position." , "将反曲之蛇替换为猎人缠绕/迅皮缠绕。\n根据你的站位自动切换。"  },
        {"Vicepit - Dens" , "反曲陷阱 - 洞穴"  },
        {"Replaces Vicepit with Hunter's/Swiftskin's Dens." , "将反曲陷阱替换为猎人洞穴/迅皮洞穴。"  },
        {"Uncoiled - Twins" , "解缠 - 双牙"  },
        {"Replaces Uncoiled Fury with Uncoiled Twinfang and Uncoiled Twinblood." , "将解缠之怒替换为解缠的双牙和解缠的双血。"  },
        {"Reawaken - Generation" , "复苏 - 生代"  },
        {"Replaces Option with the Generations." , "将选项替换为生代。"  },
        {"Reawaken - Legacy" , "复苏 - 遗产"  },
        {"Replaces Option with the Legacys." , "将选项替换为遗产。"  },
        {"Combined Combo Ability Feature" , "组合连击功能"  },
        {"Combines Serpent's Tail, Twinfang, and Twinblood to one button." , "将蛇尾、双牙和双血组合为一个按键。"  },
        {"Include Twin Combo Actions" , "包含双牙连击动作"  },
        {"Adds Twinfang and Twinblood to the button." , "将双牙和双血添加到按键中。"  },
        #endregion
        #region WARRIOR
        ...
        {"Swift Holy Pull 'Opener' Option" , "等待翻译"  },
        {"Adds a Swiftcast->Holy at the beginning of your AoE rotation.\nRequires you to already be in combat, to have stopped moving, and to not have used Assize yet." , "等待翻译"  },
        {"Adds Assize to the AoE combo." , "将法令整合AoE循环中."  },
        {"Glare IV Option" , "等待翻译"  },
        {"Adds Glare IV to the AoE combo when under Sacred Sight" , "等待翻译"  },
        ...
        {"Aqualveil Option" , "水幕选项"  },
        {"Uses Aquaveil when available." , "可用时使用水幕。"  },
        {"Esuna Option" , "康复选项"  },
        ...
        #region ST
        {"Replaces Fire in Red with a one-button full single target rotation.\nThese features are ideal if you want to customize the rotation." , "将红色中的火焰替换为一个单体目标的完整循环按键。\n这些功能非常适合自定义循环。"  },
        {"Balance Opener Option" , "平衡起手选项"  },
        {"Uses the Balance Opener depending on your current level. \n Supports lvl 70, 80, 90, 92, 100. \n - Requirements: \n - Starry Muse off cooldown \n - Pom. Weapon, Landscape Motif" , "根据当前等级使用平衡起手。\n支持等级 70、80、90、92、100。\n - 要求：\n - 星辉缪斯冷却完毕\n - Pom. 武器，风景主题"  },
        {"Early Balance Opener Option" , "早期平衡起手选项"  },
        {"Uses Early Starry Muse Balance Opener depending on your current level." , "根据当前等级使用早期星辉缪斯平衡起手。"  },
        {"Prepull Motifs Feature" , "战斗前主题功能"  },
        {"Adds missing Motifs to the combo while out of combat." , "在非战斗状态下，将缺少的主题添加到连击中。"  },
        {"Downtime Motifs Option" , "战斗空闲主题选项"  },
        {"Adds missing Motifs to the combo while no target is present in combat." , "在战斗中没有目标时，将缺少的主题添加到连击中。"  },
        {"Starry Muse Burst Feature" , "星辉缪斯爆发功能"  },
        {"Adds selected spells below to the burst phase." , "将以下选择的技能添加到爆发阶段。"  },
        {"Comet in Black Option" , "黑色彗星选项"  },
        {"Adds Comet in Black to the burst phase." , "将黑色彗星添加到爆发阶段。"  },
        {"Star Prism Option" , "星棱镜选项"  },
        {"Adds Star Prism to the burst phase." , "将星棱镜添加到爆发阶段。"  },
        {"Rainbow Drip Option" , "彩虹滴选项"  },
        {"Adds Rainbow Drip to the burst phase." , "将彩虹滴添加到爆发阶段。"  },
        {"Hammer Stamp Combo Option" , "锤印连击选项"  },
        {"Adds Hammer Stamp Combo to the burst phase." , "将锤印连击添加到爆发阶段。"  },
        {"Blizzard in Cyan Option" , "青色暴风雪选项"  },
        {"Adds Blizzard in Cyan to the burst phase." , "将青色暴风雪添加到爆发阶段。"  },
        {"Motif Selection Feature" , "主题选择功能"  },
        {"Add Selected Motifs to the combo." , "将选择的主题添加到连击中。"  },
        {"Landscape Motif Option" , "风景主题选项"  },
        {"Adds Landscape Motif." , "添加风景主题。"  },
        {"Creature Motif Option" , "生物主题选项"  },
        {"Weapon Motif Option" , "武器主题选项"  },
        {"Adds Weapon Motif." , "添加武器主题。"  },
        {"Muse Selection Feature" , "缪斯选择功能"  },
        {"Adds Selected Muses to the combo." , "将选择的缪斯添加到连击中。"  },
        {"Scenic Muse Option" , "风景缪斯选项"  },
        {"Adds Scenic Muse." , "添加风景缪斯。"  },
        {"Living Muse Option" , "生命缪斯选项"  },
        {"Adds Living Muse." , "添加生命缪斯。"  },
        {"Steel Muse Option" , "钢铁缪斯选项"  },
        {"Adds Steel Muse." , "添加钢铁缪斯。"  },
        {"Mog/Madeen Feature" , "莫古/玛蒂恩功能"  },
        {"Adds Mog/Madeen to the combo." , "将莫古/玛蒂恩添加到连击中。"  },
        {"Subtractive Palette Feature" , "减色调色板功能"  },
        {"Adds Subtractive Palette to the combo." , "将减色调色板添加到连击中。"  },
        {"Adds Comet in Black to the combo." , "将黑色彗星添加到连击中。"  },
        {"Adds Hammer Stamp combo." , "添加锤印连击。"  },
        {"Movement Features" , "移动功能"  },
        {"Adds selected features to the combo while moving." , "在移动时将选择的功能添加到连击中。"  },
        {"Adds Hammer Stamp Combo to the combo while moving." , "在移动时添加锤印连击。"  },
        {"Holy in White Option" , "白色圣光选项"  },
        {"Adds Holy in White to the combo while moving." , "在移动时将白色圣光添加到连击中。"  },
        {"Adds Comet in Black to the combo while moving." , "在移动时将黑色彗星添加到连击中。"  },
        {"Swiftcast Option " , "迅捷施法选项"  },
        {"Adds Swiftcast to the combo while moving." , "在移动时将迅捷施法添加到连击中。"  },
        {"Adds Blizzard in Cyan to the combo." , "将青色暴风雪添加到连击中。"  },
        {"Adds Lucid Dreaming to the combo." , "将清醒梦添加到连击中。"  },
        #endregion
        #region AoE
        {"Replaces Fire II in Red with a one-button full AoE rotation.\nThese features are ideal if you want to customize the rotation." , "将红色中的火焰II替换为一个范围伤害的完整循环按键。\n这些功能非常适合自定义循环。"  },
        {"Adds Holy in White to the combo." , "将白色圣光添加到连击中。"  },
        {"Combined Aetherhues Feature" , "组合以太色彩功能"  },
        {"Merges aetherhue actions for specific target types into a single button." , "将针对特定目标类型的以太色彩技能合并为一个按键。"  },
