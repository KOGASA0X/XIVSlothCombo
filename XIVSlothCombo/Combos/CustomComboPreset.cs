...
namespace XIVSlothCombo.Combos
{
    ...
    public enum CustomComboPreset
    {
        ...
        #region Cooldowns
        [ParentCombo(GNB_ST_MainCombo)]
        [CustomComboInfo("GNB_ST_Cooldowns on Main Combo Option", "Adds various cooldowns to the main combo when under No Mercy or when No Mercy is on cooldown.", GNB.JobID, 0, "", "")]
